...
import cn.hncu.bean.AdminUser;
import cn.hncu.pojo.Users;
import cn.hncu.service.impl.UsersServiceImpl;
...
public class UsersController {
	...
	@PostMapping("login")
	@ResponseBody
	public hncuJSONResult userLogin(String username, String password,
			HttpServletRequest request, HttpServletResponse response) {
		 
		//模拟登陆
		if (StringUtils.isBlank(username) || StringUtils.isBlank(password)) {
			return hncuJSONResult.errorMap("用户名和密码不能为空");
		} else if (username.equals("zhang") && password.equals("zhang")) {
		...
		return hncuJSONResult.errorMsg("登陆失败，请重试...");
	}
